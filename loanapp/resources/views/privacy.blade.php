...
<head>
    ...
    <meta name="description" content="Ghana Personal Loans Calculator - privacy policy">
    <title>Ghana Loans Calculator - privacy Policy</title>
...
<body>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <h2 class="text-center mb-4">Privacy Policy</h2>
                    <section>
        <p>This Privacy Policy governs the manner in which Wanderlustexplored collects, uses, maintains, and discloses information collected from users (each, a “User”) of the <a href="http://Wanderlustexplored.com">Wanderlustexplored.com</a> website (“Site”).</p>
    </section>

    <section>
        <h2>Personal Identification Information</h2>
        <p>We may collect personal identification information from Users in a variety of ways, including, but not limited to, when Users visit our site, register on the site, fill out a form, and in connection with other activities, services, features, or resources we make available on our Site. Users may be asked for, as appropriate, name, email address, and phone number. Users may, however, visit our Site anonymously. We will collect personal identification information from Users only if they voluntarily submit such information to us. Users can always refuse to supply personally identifiable information, except that it may prevent them from engaging in certain Site-related activities.</p>
    </section>
    ...
    <section>
        ...
        <p>Wanderlustexplored may collect and use Users' personal information for the following purposes:</p>
        <ul>
            <li><strong>To run and operate our Site:</strong> We may need your information to display content on the Site correctly.</li>
    ...
    <section>
        ...
        <p>Wanderlustexplored has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
    </section>
    ...
    <section>
        ...
        <p>Email: <a href="mailto:emmanualkobby@gmail.com">emmanualkobby@gmail.com</a></p>
        <p>Phone: +233 20 239 7078</p>
    </section>
